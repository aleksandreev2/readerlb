...
class EpubLimitsTest {
    @Test fun cumulativeImageBudgetRejectsNextImage() {
    ...
    @Test fun sourceCopyRejectsOversizeAndDeletesPartialFile() {
    ...
    @Test fun sourceCopyPreservesAllowedInput() {
        val target = Files.createTempFile("epub_limit_", ".epub").toFile()
        try {
    ...
    @Test fun sourceCopyHonorsInterruptionAndDeletesPartialFile() {
    ...
    @Test fun corruptArchiveRemovesTemporaryAssets() {
